...
1. [huggingface/pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,440 | 🐛 2,424 | 🌐 Python | 📅 2026-09-20,   A PyTorch implementation of Google AI's BERT model with script to load Google's pre-trained models,
...
1. [ymcui/Chinese-BERT-wwm](https://github.com/ymcui/Chinese-BERT-wwm) ⭐ 10,230 | 🐛 1 | 🌐 Python | 📅 2026-04-19, Pre-Training with Whole Word Masking for Chinese BERT（中文BERT-wwm预训练模型） <https://arxiv.org/abs/1906.08101>,
...
9. [GaoPeng97/transformer-xl-chinese](https://github.com/GaoPeng97/transformer-xl-chinese) ⭐ 723 | 🐛 15 | 🌐 Python | 📅 2022-04-07, transformer xl在中文文本生成上的尝试。（transformer xl for text generation of chinese）,
...
1. [allenai/scibert](https://github.com/allenai/scibert) ⭐ 1,716 | 🐛 60 | 🌐 Python | 📅 2022-02-22, A BERT model for scientific text. <https://arxiv.org/abs/1903.10676>,
...
8. [NoviScl/BERT-RACE](https://github.com/NoviScl/BERT-RACE) ⭐ 79 | 🐛 1 | 🌐 Python | 📅 2022-10-22, This work is based on Pytorch implementation of BERT (<https://github.com/huggingface/pytorch-pretrained-BERT> ⭐ 166,440 | 🐛 2,424 | 🌐 Python | 📅 2026-09-20). I adapted the original BERT model to work on multiple choice machine comprehension.
...
1. [jessevig/bertviz](https://github.com/jessevig/bertviz) ⭐ 8,183 | 🐛 22 | 🌐 Python | 📅 2026-01-08, Tool for visualizing BERT's attention,
...
1. [NVIDIA/Megatron-LM](https://github.com/NVIDIA/Megatron-LM) ⭐ 17,957 | 🐛 1,375 | 🌐 Python | 📅 2026-09-20, Ongoing research training transformer language models at scale, including: BERT,
...
1. [UKPLab/sentence-transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 19,103 | 🐛 1,306 | 🌐 Python | 📅 2026-09-18, Sentence Embeddings with BERT & XLNet,
