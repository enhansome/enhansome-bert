...
AD:  a repository for graph convolutional networks at <https://github.com/Jiakui/awesome-gcn> ⭐ 907 | 🐛 3 | 📅 2019-07-12 (resources for graph convolutional networks  （图卷积神经网络相关资源）).
...
7. [arXiv:1904.02232](https://arxiv.org/abs/1904.02232), BERT Post-Training for Review Reading Comprehension and Aspect-based Sentiment Analysis, Authors: Hu Xu, Bing Liu, Lei Shu, Philip S. Yu, \[[code](https://github.com/howardhsu/BERT-for-RRC-ABSA) ⭐ 461 | 🐛 12 | 🌐 Python | 📅 2021-02-05]
...
1. [huggingface/pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,164 | 🐛 2,435 | 🌐 Python | 📅 2026-09-15,   A PyTorch implementation of Google AI's BERT model with script to load Google's pre-trained models,
...
2. [PaddlePaddle/LARK](https://github.com/PaddlePaddle/LARK) ⭐ 7,735 | 🐛 83 | 🌐 Python | 📅 2026-07-24,  LAnguage Representations Kit, PaddlePaddle implementation of BERT. It also contains an improved version of BERT, ERNIE, for chinese NLP tasks.  BERT 的中文改进版 ERNIE,
   ![](https://img.shields.io/github/stars/PaddlePaddle/LARK.svg)

3. [PaddlePaddle/ERNIE](https://github.com/PaddlePaddle/ERNIE) ⭐ 7,735 | 🐛 83 | 🌐 Python | 📅 2026-07-24,  An Implementation of ERNIE For Language Understanding (including Pre-training models and Fine-tuning tools)  BERT 的中文改进版 ERNIE,
...
6. [kimiyoung/transformer-xl](https://github.com/kimiyoung/transformer-xl) ⭐ 3,715 | 🐛 98 | 🌐 Python | 📅 2022-09-21, Transformer-XL: Attentive Language Models Beyond a Fixed-Length Context, This repository contains the code in both PyTorch and TensorFlow for our paper.
...
2. [EmilyAlsentzer/clinicalBERT](https://github.com/EmilyAlsentzer/clinicalBERT) ⭐ 776 | 🐛 10 | 🌐 Python | 📅 2020-08-25, repository for Publicly Available Clinical BERT Embeddings
   ![](https://img.shields.io/github/stars/EmilyAlsentzer/clinicalBERT.svg)

3. [kexinhuang12345/clinicalBERT](https://github.com/kexinhuang12345/clinicalBERT) ⭐ 451 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2022-10-17, ClinicalBERT: Modeling Clinical Notes and Predicting Hospital Readmission <https://arxiv.org/abs/1904.05342>
...
3. [xmxoxo/BERT-train2deploy](https://github.com/xmxoxo/BERT-train2deploy) ⭐ 530 | 🐛 21 | 🌐 CSS | 📅 2020-09-23, Bert Model training and deploy, BERT模型从训练到部署,
...
8. [NoviScl/BERT-RACE](https://github.com/NoviScl/BERT-RACE) ⭐ 79 | 🐛 1 | 🌐 Python | 📅 2022-10-22, This work is based on Pytorch implementation of BERT (<https://github.com/huggingface/pytorch-pretrained-BERT> ⭐ 166,164 | 🐛 2,435 | 🌐 Python | 📅 2026-09-15). I adapted the original BERT model to work on multiple choice machine comprehension.
...
3. [HSLCY/ABSA-BERT-pair](https://github.com/HSLCY/ABSA-BERT-pair) ⭐ 518 | 🐛 11 | 🌐 Python | 📅 2022-01-04, Utilizing BERT for Aspect-Based Sentiment Analysis via Constructing Auxiliary Sentence (NAACL 2019) <https://arxiv.org/abs/1903.09588>,
...
1. [macanv/BERT-BiLSMT-CRF-NER](https://github.com/macanv/BERT-BiLSMT-CRF-NER) ⭐ 4,910 | 🐛 146 | 🌐 Python | 📅 2021-02-24, Tensorflow solution of NER task Using BiLSTM-CRF model with Google BERT Fine-tuning  ,
...
5. [lemonhu/NER-BERT-pytorch](https://github.com/lemonhu/NER-BERT-pytorch) ⭐ 445 | 🐛 19 | 🌐 Python | 📅 2023-03-30, PyTorch solution of NER task Using Google AI's pre-trained BERT model.
...
1. [asyml/texar](https://github.com/asyml/texar) ⭐ 2,387 | 🐛 40 | 🌐 Python | 📅 2026-07-21, Toolkit for Text Generation and Beyond <https://texar.io>, Texar is a general-purpose text generation toolkit, has also implemented BERT here for classification, and text generation applications by combining with Texar's other modules.
   ![](https://img.shields.io/github/stars/asyml/texar.svg)

2. [Tiiiger/bert\_score](https://github.com/Tiiiger/bert_score) ⭐ 1,919 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2024-07-30, BERT score for language generation,
...
1. [jessevig/bertviz](https://github.com/jessevig/bertviz) ⭐ 8,179 | 🐛 22 | 🌐 Python | 📅 2026-01-08, Tool for visualizing BERT's attention,
...
1. [NVIDIA/Megatron-LM](https://github.com/NVIDIA/Megatron-LM) ⭐ 17,908 | 🐛 1,348 | 🌐 Python | 📅 2026-09-15, Ongoing research training transformer language models at scale, including: BERT,
   ![](https://img.shields.io/github/stars/NVIDIA/Megatron-LM.svg)

2. [hanxiao/bert-as-service](https://github.com/hanxiao/bert-as-service) ⭐ 12,834 | 🐛 304 | 🌐 Python | 📅 2024-01-23,    Mapping a variable-length sentence to a fixed-length vector using pretrained BERT model,
...
1. [UKPLab/sentence-transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 19,094 | 🐛 1,311 | 🌐 Python | 📅 2026-09-11, Sentence Embeddings with BERT & XLNet,
...
2. [dragen1860/TensorFlow-2.x-Tutorials](https://github.com/dragen1860/TensorFlow-2.x-Tutorials) ⭐ 6,339 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2020-09-23, TensorFlow 2.x version's Tutorials and Examples, including CNN, RNN, GAN, Auto-Encoders, FasterRCNN, GPT, BERT examples, etc. TF 2.0版入门实例代码，实战教程。,
