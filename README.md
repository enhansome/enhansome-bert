...
1. [huggingface/pytorch-pretrained-BERT](https://github.com/huggingface/pytorch-pretrained-BERT) ⭐ 166,325 | 🐛 2,414 | 🌐 Python | 📅 2026-09-19,   A PyTorch implementation of Google AI's BERT model with script to load Google's pre-trained models,
...
1. [ymcui/Chinese-BERT-wwm](https://github.com/ymcui/Chinese-BERT-wwm) ⭐ 10,228 | 🐛 1 | 🌐 Python | 📅 2026-04-19, Pre-Training with Whole Word Masking for Chinese BERT（中文BERT-wwm预训练模型） <https://arxiv.org/abs/1906.08101>,
...
8. [NoviScl/BERT-RACE](https://github.com/NoviScl/BERT-RACE) ⭐ 79 | 🐛 1 | 🌐 Python | 📅 2022-10-22, This work is based on Pytorch implementation of BERT (<https://github.com/huggingface/pytorch-pretrained-BERT> ⭐ 166,325 | 🐛 2,414 | 🌐 Python | 📅 2026-09-19). I adapted the original BERT model to work on multiple choice machine comprehension.
...
1. [jessevig/bertviz](https://github.com/jessevig/bertviz) ⭐ 8,181 | 🐛 22 | 🌐 Python | 📅 2026-01-08, Tool for visualizing BERT's attention,
...
1. [NVIDIA/Megatron-LM](https://github.com/NVIDIA/Megatron-LM) ⭐ 17,945 | 🐛 1,371 | 🌐 Python | 📅 2026-09-19, Ongoing research training transformer language models at scale, including: BERT,
...
1. [UKPLab/sentence-transformers](https://github.com/UKPLab/sentence-transformers) ⭐ 19,102 | 🐛 1,303 | 🌐 Python | 📅 2026-09-18, Sentence Embeddings with BERT & XLNet,
